...
function App() {
  ...
  const updates = [
    ...
    { updateDate: "2024-11-01", status: "Completed", updatesDone: "List of Licenses and Registrations required" },
    { updateDate: "2024-11-05", status: "Completed", updatesDone: "Swiggy, Instamart, etc. tie-up options, Products Sourcing Leads" },
    ...
    { updateDate: "2024-11-21", status: "In Progress", updatesDone: "Final Report" },
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          {/* New Expandable Section for Expandable Google maps Analysis Link */}
            <details><summary><span style={{ display: 'inline' }}><h3 style={{ display: 'inline', margin: 0 }}>Google maps Analysis Link</h3></span></summary>
              <p><a href="https://www.google.com/maps/d/edit?mid=1qv6ZVRfqWDCUpMEzuGsc2xyAmrF2FLk&ll=17.47797239283841%2C78.34848710200289&z=14">https://www.google.com/maps/d/edit?mid=1qv6ZVRfqWDCUpMEzuGsc2xyAmrF2FLk&ll=17.47797239283841%2C78.34848710200289&z=14</a></p>
            </details>
...
{/* \\============================================================================================================================           */}
          <details>
            ...
            <details><summary style={{margin: '0px 0px 0px 50px'}}><span style={{ display: 'inline' }}>2. Labour licence for staff</span></summary>
            <p>&emsp;&emsp;&emsp;&emsp;procedure link : <u>https://labour.telangana.gov.in/home.do</u></p></details>
            ...
            <details><summary style={{margin: '0px 0px 0px 50px'}}><span style={{ display: 'inline' }}>6. FSSAI certificate</span></summary>
                          <p>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;https://foodlicenseportal.org/Home/application</p>
                          <p>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;1.	Important Points</p>
    ...
    {/* \\============================================================================================================================           */}
            ...
            <summary style={{margin: '0px 0px 0px 50px'}}>
              <span style={{ display: 'inline' }}>
                <p style={{ display: 'inline', margin: 0 }}>9. Local traders for Dals, pulses, Oils and All General products</p>
              </span>
            </summary>
            <table style={{ width: '100%', borderCollapse: 'collapse', border: '1px solid #ccc' }}>
              <thead>
